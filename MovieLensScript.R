...
movieId_model <- RMSE(predicted_ratings_bi, test_set$rating)

rmse_table <- rbind(rmse_table,
                    data_frame(Method = "Predicted movie ratings regression model using movieId averages", RMSE = movieId_model))
...
movieId_userId_model <- RMSE(predicted_ratings_bu, test_set$rating)

rmse_table <- rbind(rmse_table,
                    data_frame(Method = "Predicted movie ratings regression model using movieId and userid averages", RMSE = movieId_userId_model))
...
movieId_userId_date_model <- RMSE(predicted_ratings_bt, test_set$rating)

rmse_table <- rbind(rmse_table,
                    data_frame(Method = "Predicted movie ratings regression model using movieId, userid, and date averages", RMSE = movieId_userId_date_model))
